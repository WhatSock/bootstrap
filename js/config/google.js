  ...
  [
    {
      ...
      google: {
        ...
        init: function(dc) {
          dc.google.LatLng.loc = new google.maps.LatLng(
            dc.google.LatLng.lat,
            dc.google.LatLng.lng
          );
          ...
          dc.google.map = new google.maps.Map(
            dc.google.container,
            dc.google.options
          );
        },
        set: function(lat, lng, zoom) {
          ...
          if (lat) dc.google.LatLng.lat = lat;

          if (lng) dc.google.LatLng.lng = lng;

          if (zoom) dc.google.options.zoom = parseInt(zoom);
          dc.google.LatLng.loc = new google.maps.LatLng(
            dc.google.LatLng.lat,
            dc.google.LatLng.lng
          );
